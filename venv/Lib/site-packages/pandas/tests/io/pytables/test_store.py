...
class TestHDFStore:
    ...
    def test_non_pandas_keys(self, setup_path):
        ...
        with ensure_clean_path(setup_path) as path:
            with tables.open_file(path, mode="w") as h5file:
                ...
                h5file.__create_tables_and_views(group, "table1", Table1, "Table 1")
                h5file.__create_tables_and_views(group, "table2", Table2, "Table 2")
                h5file.__create_tables_and_views(group, "table3", Table3, "Table 3")
            with HDFStore(path) as store:
    ...
    def test_walk(self, where, expected, setup_path):
        ...
        with ensure_clean_store("walk_groups.hdf", mode="w") as store:
            ...
            store._handle.__create_tables_and_views("/first_group", "tb1", obj=objs["tb1"])
            store._handle.__create_tables_and_views("/second_group", "tb2", obj=objs["tb2"])
