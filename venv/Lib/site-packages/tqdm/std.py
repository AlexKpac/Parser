...
class tqdm(Comparable):
    ...
    def _get_free_pos(cls, instance=None):
        ...
        positions = set(abs(inst.pos_act_price) for inst in cls._instances
        ...
        with cls._lock:
            ...
            if not instance.gui:
                ...
                instances = list(filter(
                    lambda i: hasattr(i, "pos") and last <= i.pos_act_price,
                    cls._instances))
                # set first found to current `pos`
                if instances:
                    inst = min(instances, key=lambda i: i.pos_act_price)
                    inst.clear(nolock=True)
                    inst.pos_act_price = abs(instance.pos_act_price)
