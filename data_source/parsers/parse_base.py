...
class ParseBase(ABC):
    ...
    def __init__(self, domain, shop, logger, cur_page=2):
        self.logger = logger
    ...
    def _save_result(self):
        ...
        """
        with open(h.CSV_PATH_RAW + self.shop, 'w', newline='') as f:
            ...
            for item in self.pr_result_list:
                try:
                    ...
                    self.logger.error("Ошибка кодировки при попытке сохранить csv, item: '{}'\n{}".format(item, e))
